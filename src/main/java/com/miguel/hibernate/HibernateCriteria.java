...
public class HibernateCriteria {
  public static void main(String[] args) {
    ...
    clientes = em.createQuery(query).setParameter("nombre", "Miguel").getResultList();
    clientes.forEach(System.out::println);
    ...
    clientes = em.createQuery(query).setParameter("nombreParam", "%mi%")
        .getResultList();
    clientes.forEach(System.out::println);
    ...
    clientes = em.createQuery(query)
        .setParameter("nombres", Arrays.asList("Miguel", "Maria"))
        .getResultList();
    clientes.forEach(System.out::println);
    ...
    query = criteria.createQuery(Cliente.class);
    from = query.from(Cliente.class);
    Predicate porNombre = criteria.equal(from.get("nombre"), "Miguel");
    ...
    from = queryObject.from(Cliente.class);
    queryObject.multiselect(from.get("id"), from.get("nombre"), from.get("apellido"))
        .where(criteria.like(from.get("nombre"), "%mi%"));
    ...
    System.out
        .println("=========== ejemplo varios resultados de funciones de agregacion en una sola consulta ==========");

    queryObject = criteria.createQuery(Object[].class);
    from = queryObject.from(Cliente.class);
    queryObject.multiselect(criteria.count(from.get("id")), criteria.sum(from.get("id")), criteria.max(from.get("id")),
